...
- `bin/aggregate_results` reads result files plus `config/model_variants.json` and emits structured implementation metadata into both benchmark payloads and `implementations.json`
