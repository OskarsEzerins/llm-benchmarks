...
class ParkingGarage
  ...
  def exit_car(license_plate_no)
    ...
    small_car  = @parking_spots[:small_spot].find { |c| c[:plate] == plate_str }
...
class ParkingFeeCalculator
  ...
  def calculate_fee(car_size, duration_hours)
    ...
    normalized_size = car_size.to_s.downcase
    rate = RATES[normalized_size] || RATES['small']
    max = MAX_FEE[normalized_size] || MAX_FEE['small']
