...
class App
  ...
  def create_student
    ...
    parent_permission = valid_parent_permission(gets&.chomp)
  ...
  def create_teacher
    ...
    specialization = valid_name(gets&.chomp, 'Unknown')
  ...
  def create_book
    print 'Title: '
    title = valid_name(gets&.chomp, 'Untitled')

    print 'Author: '
    author = valid_name(gets&.chomp, 'Unknown')
  ...
  def valid_name(name, fallback = 'Unknown')
    return fallback if name.nil? || name.strip.empty?
  ...
  def valid_parent_permission(response)
